<!-- pre-align:aligned sig=b089b9c7a6d3 -->

<a id="common-launching-getting-started"></a>
## Common > Launching > Getting Started { #common-launching-getting-started }

Launching 서비스를 사용하기 위한 절차는 다음과 같습니다.

<a id="common-launching-getting-started-1"></a>
### 서비스 활성화 { #common-launching-getting-started-1 }
